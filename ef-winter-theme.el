...
(eval-and-compile
  ...
  (defconst ef-winter-palette
    '(;; Basic tones
      ...
      ;; Diffs
      (bg-added          "#053d2f")
      (bg-added-faint    "#052f1f")
      (bg-added-refine   "#085f3f")

      (bg-changed        "#423200")
      (bg-changed-faint  "#2a1b00")
      (bg-changed-refine "#585000")

      (bg-removed        "#4a192f")
      (bg-removed-faint  "#3a121f")
      (bg-removed-refine "#67283f")
